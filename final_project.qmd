...
box_cm_country <- ggplot(ea_countries_data, aes(x = country, y = child_mortality_rate_per_1000, fill = country)) +
  geom_boxplot() +
  labs(title = "Distribution of Child Mortality Rate by Country", y = "Mortality Rate", x = "") +
  theme_minimal() +
  theme(legend.position = "none",
...
box_sh_country <- ggplot(ea_countries_data, aes(x = country, y = mean_years_in_school_women_15_to_44, fill = country)) +
  geom_boxplot() +
  labs(title = "Distribution of Female Education by Country", y = "Mean Years", x = "") +
  theme_minimal() +
  theme(legend.position = "none",
        axis.text.x = element_text(angle = 45, hjust = 1))
...
hist_cm_ea <- ggplot(ea_countries_data, aes(x = child_mortality_rate_per_1000)) +
  ...
  labs(title = "Histogram of Child Mortality Rates", x = "Mortality Rate", y = "Frequency") +
  theme_minimal()
...
hist_sh_ea <- ggplot(ea_countries_data, aes(x = mean_years_in_school_women_15_to_44)) +
  ...
  labs(title = "Histogram of Female Education (15–44)", x = "Years in School", y = "Frequency") +
  theme_minimal()
...
```{r title = "Association between Mean Years in School and Child Mortality"}
